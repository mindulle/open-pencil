...
//#region src/tools/modify/paint.ts
const setFill = defineTool({
	name: "set_fill",
	mutates: true,
	...
	params: {
		...
		color_end: {
			type: "color",
			description: "End color for gradient (if omitted, solid fill)"
		},
		gradient: {
			type: "string",
...
//#endregion
export { setFill, setImageFill, setStroke };
