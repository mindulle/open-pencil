...
//#region src/tools/modify/state.ts
const setVisible = defineTool({
	...
	params: {
		...
		value: {
			type: "boolean",
			description: "Visible (true/false)",
			required: true
		}
	},
...
const setStrokeAlign = defineTool({
...
//#endregion
export { setBlend, setLocked, setStrokeAlign, setVisible };
